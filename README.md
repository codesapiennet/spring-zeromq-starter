...
| <img src="./spring-zmq-logo.webp" alt="Spring ZMQ Logo" width="120" /> | **Goal** – Provide a **Spring Boot starter** that gives developers a *zero‑dependency* (no external broker) messaging layer built on **ZeroMQ** (JeroMQ) with **full end‑to‑end CURVE encryption**, annotation‑driven APIs and complete auto‑configuration.  <br><br>The three files below (`README.md`, `RULES.md`, `WORKFLOWS.md`) contain **every class, configuration, and script** you need to copy‑paste into a new project – no additional scaffolding required. |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
